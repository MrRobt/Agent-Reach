...
description: >
  ...
  雪球/股票行情, Bluesky, Twitch, Threads, TikTok, RSS feeds, or any web URL.

  19 platforms, multi-backend routing (OpenCLI / per-platform CLIs / APIs).
  ...
  分类：search / social (小红书/推特/B站/V2EX/Reddit/Facebook/Instagram/Bluesky/Twitch/Threads/TikTok) / career(LinkedIn) / dev(github) / web(网页/文章/RSS) / video(YouTube/B站/播客)。
triggers:
  ...
  - social:
    ...
    - Bluesky: bluesky/bsky/atproto/蓝天
    - Twitch: twitch/tv
    - Threads: threads/threads.net/@
    - TikTok: tiktok/抖音海外版/抖音/tik tok
...
19 平台、多后端。**本 skill 存在时必须用它访问这些平台，不要自己发明方案。**
...
| 小红书/推特/B站/V2EX/Reddit/Facebook/Instagram/Bluesky/Twitch/Threads/TikTok | social | [references/social.md](references/social.md) |
